        ...
        <div className='FindTutor'>
           ...
           <div className="hero-content">
                <div className="left">
                    ...
                    <p>Our team is on standby and ready to help! Our tailored matching service is free and easy-to-use, with no obligations.</p>
                </div>
                <div className="right">
                    <img src="https://cdn.mytutor.co.uk/icons/student-laptop-tutor.svg?1619727493000" alt=""/>
                </div>
            </div>
           </div>
           ...
           <div className="form-area">
               ...
               <label htmlFor="week2">TWICE A WEEK</label>
                            ...
                            <div className="radio-wrapper">
                            <input type="radio" name="lesson-duration" id="lesson-not-sure"/>
                   ...
                   <div className="radio-container">
                        ...
                        <div className="radio-container-content">
                            <div className="radio-wrapper">
                                ...
                                <label htmlFor="low">
                                    <h4>£18 - £20</h4>
                        <p>New to MyTutor and with lots of availability and earning some great early reviews</p>
                            ...
                            <label htmlFor="mid">
                                    <h4>£21 - £25</h4>
                                    <p>Tutoring for over 6 months, completed lots of lessons and received very positive reviews</p>
                                </label>
                            </div>
                            ...
                            <label htmlFor="high">
                                    <h4>£26 - £43</h4>
                                    <p>Our most accomplished tutors. Excellent reviews and a track record proven results</p>
                                </label>
                            </div>
                            <div className="radio-wrapper">
                   ...
                   <div className="time-container">
                        <label htmlFor="">AWHEN IS A GOOD TIME TO HAVE A FREE MEETING WITH YOUR TUTOR?</label>
                        <div className="time-container-content">
                            ...
                            <div className="time-wrapper">
                            <label htmlFor="find-tutor-pick-time" >PICK A TIME (UK TIME)</label>
               ...
               <label htmlFor="FEMALE">FEMALE</label>
                   ...
                   <div className="textarea-wrapper">
                       <label htmlFor="student-info-textarea">IS THERE ANYTHING ELSE WE SHOULD KNOW?</label>
                       <textarea name="" id="student-info-textarea" cols="30" rows="10"></textarea>
                   </div>

                   {/* CONTACT DETAILS */}
                   <div className="contact-details">
                        <h1>Your contact details</h1>
                        <p>Our tutor expert team will get back to you within the hour. We’ll then help you sort a free 15 minute meeting (in our lesson space) so you can get to know them before booking any lessons.</p>

                        <div className="contact-input-wrapper">
                            <label htmlFor="student-contact-name">full name</label>
                            <input type="text"  id="student-contact-name" placeholder="Type your full name"/>
                        </div>
                        <div className="contact-input-wrapper">
                            <label htmlFor="student-contact-email">email</label>
                            <input type="email" id="student-contact-email" placeholder="Type your email"/>
                        </div>
                        <div className="contact-input-wrapper">
                            <label htmlFor="student-phone-number">PHONE NUMBER</label>
                            <input type="text" id="student-phone-number" placeholder="Type your phone number
                            "/>
                        </div>

                        <input type="submit" value="submit request" className="submit-button-tutor-find-out"/>
                   </div>
               </form>
           </div>
            <Footer />
