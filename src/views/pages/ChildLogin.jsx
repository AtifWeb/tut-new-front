...
function ChildLogin({ img, title, desc, mainheading }) {
  ...
  const HandleLogin=async e=>{
    ...
    await AxiosInstance.post(`/${type}/login`,UserData).then(res=>{
      console.log(res)
      ...
      window.sessionStorage.setItem("parent_id",res.data['parentId'])
      window.sessionStorage.setItem("child_id",res.data['student_id'])
        ...
        <div className="login-form">
          ...
          <form className="login-form-pure">
            <div className="input-wrapper">
              <label htmlFor="login-email-pure">Username</label>
              <input
                type="text"
                id="login-email-pure"
